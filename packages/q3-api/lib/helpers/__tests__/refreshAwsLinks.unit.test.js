...
describe('refreshAwsLinks', () => {
  ...
  it('should replace with private link', () => {
    ...
    expect(out).toMatch(
      '<p>This is a photo <img src="https://cdn.photos/1.png" alt="From production site" /></p>',
    );
  });
});
